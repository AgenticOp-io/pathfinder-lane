...
**What it is not:** A hosted SaaS, a replacement for your PSA, or upstream PathfinderSSH itself. This tree is a **GPL-3.0 derivative** maintained by AgenticOps (`lane`). The original engine and vision are Scott Peterman’s [PathfinderSSH](https://github.com/scottpeterman/pathfinderssh).
